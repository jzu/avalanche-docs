...
export function GithubLink({ filePath, user, repo, branch = "master" }: GithubLinkProps) {
    ...
    return (
        <a
            ...
            className="flex items-center gap-1 py-2 text-sm text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
        >
            <svg
                ...
                height="16"
                viewBox="0 0 72 72"
                className="flex-shrink-0 fill-current h-6 w-6"
            >
