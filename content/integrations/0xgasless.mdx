...
- **Modular Design**: The SDK is very modularly designed to both vertical and horizontal scale. The SDK offers multiples options of customization in every component of a gasless architecture. Like multiple ways to fund and pay for your sponsorship via different types of paymasters, multiple ways to create smart wallets (for eg: social logins, passkeys, EOA wallets etc.), offers compatibility with multiple types of bundlers.
...
3. **Funding The paymaster**: Follow the [documentation](https://docs.0xgasless.com/Getting%20Started/create-a-page) and checkout the [0xGasless Dashboard](https://dashboard.0xgasless.com/) to create and fund the paymaster.
4. **Integrate the 0xGasless SDK**: Leverage 0xGasless's SDK [documentation](https://docs.0xgasless.com/Getting%20Started/create-a-page#step-1-obtain-required-api-keys) to integrate gasless transactions in your dapp.
...
**AI Agents**  Streamline payment processes with smart accounts for AI Agents, The new era of AI demands a more secure and smoother infrastructure for AI agents to interact with the concept of money, and account abstraction is a perfect standard for AI agents to build their use cases.
