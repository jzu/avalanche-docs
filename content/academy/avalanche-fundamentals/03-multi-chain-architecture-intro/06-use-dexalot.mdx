...
![](https://qizat5l3bwvomkny.public.blob.vercel-storage.com/builders-hub/course-images/avalanche-fundamentals/15-zFBZ8dwSCQZiy9Ca7kTAKxPtIXhtwn.png)

Enter 1 AVAX and click Deposit. Confirm the transaction in your wallet.

![](https://qizat5l3bwvomkny.public.blob.vercel-storage.com/builders-hub/course-images/avalanche-fundamentals/deposit-EQwdRgMxD5aaMLL0qxHWv1w2zdxamP.png)

A few moments later, your balances should be updated in the `Balances` tab:

![](https://qizat5l3bwvomkny.public.blob.vercel-storage.com/builders-hub/course-images/avalanche-fundamentals/16-3hDA5CyzKMNaNxnGICpWGa66aTM4OQ.png)
...
![](https://qizat5l3bwvomkny.public.blob.vercel-storage.com/builders-hub/course-images/avalanche-fundamentals/17-boCCYIQjxy0gXpFVwQa0Ayi2pNzeBt.png)

Now, head back to the `Balances` tab and check how the balances updated.
![](https://qizat5l3bwvomkny.public.blob.vercel-storage.com/builders-hub/course-images/avalanche-fundamentals/updated-balance-pA8YjGmb4Ehmf9TKbmIjenoEK8rEj1.png)
...
![](https://qizat5l3bwvomkny.public.blob.vercel-storage.com/builders-hub/course-images/avalanche-fundamentals/18-tYbqfBDPljFDnwPYwNrN5uWfH9l5SJ.png)
...
![](https://qizat5l3bwvomkny.public.blob.vercel-storage.com/builders-hub/course-images/avalanche-fundamentals/bridge-back-usdc-rLMSkiIDdNQQucgr6NNdiAtyJlfG2T.png)
