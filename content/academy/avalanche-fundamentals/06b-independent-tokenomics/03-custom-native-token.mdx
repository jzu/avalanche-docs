...
Many web3 startups want to provide a gas-free experience, especially if their target audience is not web3 native and is unfamiliar with paying for each action they take. If a startup deploys on a chain with no control over the gas token, the only option they have is to sponsor the transaction fees. This makes it very hard for many business models to be profitable.
