...
`CreateChainTx` on the P-Chain to create the blockchain record.

<Steps>
<Step>

### Inspect the Default Genesis
...
### Issue the CreateChainTx

Now use the Create Chain tool to issue the `CreateChainTx` transaction. This will create the
P-Chain record for your blockchain and associate it with the Subnet created in the previous step.
The `CreateChainTx` transaction as the following parameters:
