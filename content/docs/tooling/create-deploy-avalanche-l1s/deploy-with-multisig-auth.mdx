...
- Familiarity with process of [Deploying an Avalanche L1 on Testnet](/docs/avalanche-l1s/deploy-a-avalanche-l1/fuji-testnet) and [Deploying a Permissioned Avalanche L1 on Mainnet](/docs/avalanche-l1s/deploy-a-avalanche-l1/avalanche-mainnet)
...
Take a look at [Add a Validator](/docs/avalanche-l1s/deploy-a-avalanche-l1/avalanche-mainnet#add-a-validator) for additional help issuing this transaction.
