...
![](https://qizat5l3bwvomkny.public.blob.vercel-storage.com/builders-hub/course-images/multi-chain-architecture/transaction-fees/low-demand-ROW1xDwcbURumUP2Hpi5wa8E3x3ExQ.png)
...
![](https://qizat5l3bwvomkny.public.blob.vercel-storage.com/builders-hub/course-images/multi-chain-architecture/transaction-fees/high-demand-b3kITcvAfkm9hmlZwlA4V5VasQUuGm.png)
...
![](https://qizat5l3bwvomkny.public.blob.vercel-storage.com/builders-hub/course-images/multi-chain-architecture/transaction-fees/stablecoin-swap-AHqvoi6nUAnsRVoywJhWafRFkEejJN.png)

The users using these dApps will face multiple fees. In our example the fee structure could look something like this:

![](https://qizat5l3bwvomkny.public.blob.vercel-storage.com/builders-hub/course-images/multi-chain-architecture/transaction-fees/swap-fees-low-rgJfH82rJZIRUf6KWtEXaD12inji0W.png)
...
![](https://qizat5l3bwvomkny.public.blob.vercel-storage.com/builders-hub/course-images/multi-chain-architecture/transaction-fees/user-price-expectation-Eon0zUTqLZ3Vi9pSzge0VzYzy1kPtY.png)
...
![](https://qizat5l3bwvomkny.public.blob.vercel-storage.com/builders-hub/course-images/multi-chain-architecture/transaction-fees/swap-fees-high-t5ayOevkJm9A4b2aOkiGlUHAWkKPK5.png)
